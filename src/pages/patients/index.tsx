...
export function PatientListPage(props: PatientListPageProps) {
  ...
  const fetcher = useCallback(
    async () =>
      getPatients({
        relations: ['hospital', 'appointment.count', 'test_report.count'],
        limit: params.pageSize,
        offset: params.pageNumber * params.pageSize,
        searchTerm: params.searchTerm,
        order: params.order,
        searchTermKeys: ['name.contains', 'gender.contains', 'address.contains', 'phone_number.contains'],
        ...(params.filters || {}),
      }),
  ...
  const columns: ColumnType[] = [
    ...
    hasAccess('appointment', AccessOperationEnum.READ, AccessServiceEnum.PROJECT)
      ...
      : null,
    hasAccess('test_report', AccessOperationEnum.READ, AccessServiceEnum.PROJECT)
      ? {
          id: 'test_report',
          header: 'Test Report',
          accessorKey: 'test_report',
          cell: ({ row: { original: record } }: any) => record?._count?.test_report,
        }
      : null,
