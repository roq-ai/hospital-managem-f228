...
function HomePage() {
  ...
  return (
    <>
      <Head>
        <title>{`Hospital Management  v2`}</title>

        <meta
          name="description"
          content="Experience seamless healthcare operations with Hospital Management v2 - Integrating patient records, billing, medication, test reports, admissions, discharges, and doctor availability in one comprehensive system."
        />
      </Head>
      <ConfigureCodeBanner
        ...
        >
          <Box>
            ...
            <Text size="2xl" mb={{ base: '32px', lg: '48px' }} color="base.content" opacity="0.6">
              {`Experience seamless healthcare operations with Hospital Management v2 - Integrating patient records, billing, medication, test reports, admissions, discharges, and doctor availability in one comprehensive system.`}
            </Text>
            <Box
